    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            location = _args.length > 0 && _args[0] !== undefined ? _args[0] : 'Zaandam';
            unit = _args.length > 1 && _args[1] !== undefined ? _args[1] : 'metric';
            apiKey = '8d8571b1c93bd4e2325c718b62e874dc'; // const url = `https://api.openweathermap.org/data/2.5/forecast?appid=${apiKey}&q=${location}&units=${unit}`;
            // const url = `https://api.openweathermap.org/data/2.5/weather?q=${location}&appid=${apiKey}`;

            url = "https://api.openweathermap.org/data/2.5/onecall?lat=52.3676&lon=4.9041&exclude=alerts,minutely&units=".concat(unit, "&appid=").concat(apiKey);
            _context.prev = 4;
            _context.next = 7;
            return fetch(url, {
              mode: 'cors'
...
/* harmony export */   "readableTime": () => (/* binding */ readableTime)
/* harmony export */ });
var readableTime = function readableTime(unixTimestamp) {
  return new Date(unixTimestamp * 1000).toLocaleTimeString();
};
var getTodayData = function getTodayData(sunrise, sunset, currentTemp, feelsLike, humidity, wind, countryName, cityName, weatherIcon) {
  return {
    sunrise: sunrise,
    sunset: sunset,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_pages_async__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(308);
/* harmony import */ var _js_pages_functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(309);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var tempUnit = null;
var speedUnit = null;
var windSpeed = null; // Convert meters/s to km/h

var updateUnits = function updateUnits(metOrImp) {
  if (metOrImp) {
    if (metOrImp === 'metric') {
      tempUnit = '°C';
      speedUnit = 'km/h';
      windSpeed *= 3.6;
    } else if (metOrImp === 'imperial') {
      tempUnit = '°F';
      speedUnit = 'mi/h';
    }
  } else updateUnits('metric');
};

var loadPage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(location, unit) {
    var data, todayData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_js_pages_async__WEBPACK_IMPORTED_MODULE_0__.getWeather)(location, unit);

          case 2:
            data = _context.sent;
            windSpeed = data.list[0].wind.speed;
            updateUnits(unit);
            todayData = (0,_js_pages_functions__WEBPACK_IMPORTED_MODULE_1__.getTodayData)((0,_js_pages_functions__WEBPACK_IMPORTED_MODULE_1__.readableTime)(data.city.sunrise), (0,_js_pages_functions__WEBPACK_IMPORTED_MODULE_1__.readableTime)(data.city.sunset), Math.round(data.list[0].main.temp) + tempUnit, Math.round(data.list[0].main.feels_like) + tempUnit, "".concat(data.list[0].main.humidity, "%"), "".concat(Math.round(windSpeed), " ").concat(speedUnit), "".concat(data.city.country), "".concat(data.city.name), "".concat(data.list[0].weather[0].icon));
...
loadPage(); // use this to convert time to local time
// const sunrise = new Date((data.sys.sunrise + data.timezone) * 1000)

var printInOrder = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return loadPage('bangkok');

          case 2:
            newWeather = _context2.sent;
            console.log(newWeather); // await loadPage('New York', 'imperial');
            // await loadPage();
            // await loadPage('centurion');
            // loadPage('bali', 'imperial');
  ...
  return function printInOrder() {
    return _ref2.apply(this, arguments);
  };
}();

printInOrder(); // const updateToday = {
//   init: async (newLocation, newUnit) => {
//     const data = await getWeather(newLocation, newUnit);
//     loadPage()
//   },
// };
// updateToday.init('Bali');
})();
